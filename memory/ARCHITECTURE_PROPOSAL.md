...
## 2. Lesson Flow Structure (PhD-Corrected Scientific Model)

### The 10-Step Learning Cycle

The iSmart 5-step model is pedagogically incomplete. Based on curriculum science, each lesson follows this optimized sequence:
...
│                                                                              │
│  ┌─────────────┐    ┌─────────────┐    ┌─────────────┐    ┌─────────────┐   │
│  │ 1. RETRIEVAL│ → │ 2. VOCAB    │ → │ 3. MICRO    │ → │ 4. MICRO    │   │
│  │   WARM-UP   │    │   INPUT     │    │   GAME      │    │   READING   │   │
│  │   🔄        │    │   📖        │    │   🎮        │    │   📄        │   │
│  └─────────────┘    └─────────────┘    └─────────────┘    └─────────────┘   │
│         │                                                        │           │
│         │                    LEARNING CYCLE                      │           │
│         ▼                                                        ▼           │
│  ┌─────────────┐    ┌─────────────┐    ┌─────────────┐    ┌─────────────┐   │
│  │ 5. GRAMMAR  │ → │ 6. GRAMMAR  │ → │ 7. LISTENING│ → │ 8. PRODUCTION│   │
│  │   FOCUS     │    │   GAME      │    │   TASK      │    │   (Speak/   │   │
│  │   📐        │    │   🎮        │    │   🎧        │    │   Write)    │   │
│  └─────────────┘    └─────────────┘    └─────────────┘    └─────────────┘   │
│                                                                  │           │
│                                                                  ▼           │
...
└──────────────────────────────────────────────────────────────────────────────┘
        ...
        INPUT → RETRIEVAL → CONTEXT → STRUCTURE → APPLICATION → REINFORCEMENT
```
...
|------|------|---------|----------|
| 1 | **Retrieval Warm-up** | Activate previous knowledge | 2-3 min |
| 2 | **Vocabulary Input** | Present new words with images/audio | 5-8 min |
| 3 | **Micro Game (Vocab)** | Recognition + active recall | 3-5 min |
| 4 | **Micro Reading** | See vocabulary in context | 3-5 min |
| 5 | **Grammar Focus** | Present structure/pattern | 5-8 min |
| 6 | **Micro Game (Grammar)** | Pattern speed drill / error hunter | 3-5 min |
| 7 | **Listening Task** | Audio comprehension | 5-8 min |
| 8 | **Production** | Speaking or writing output | 5-10 min |
| 9 | **Exit Ticket** | Quick comprehension check | 2-3 min |
| 10 | **Auto-Review** | Schedule spaced repetition | Automatic |

**Total Lesson Duration: 35-55 minutes**

### Activity Availability by Stage

| Activity | 1-2 | 3-4 | 5-6 | 7-8 |
|----------|-----|-----|-----|-----|
| Retrieval Warm-up | ✅ Simple | ✅ | ✅ | ✅ |
| Vocabulary Input (Visual) | ✅ Heavy | ✅ | ⚡ Selective | ⚡ Minimal |
| Micro Game (Vocab) | ✅ Fun | ✅ | ✅ | ⚡ Speed-focused |
| Micro Reading | ⚡ Simple | ✅ | ✅ | ✅ Academic |
| Grammar Focus | ⚡ Basic | ✅ | ✅ | ✅ IELTS-focused |
| Micro Game (Grammar) | ✅ | ✅ | ✅ | ✅ |
| Listening Task | ✅ Simple | ✅ | ✅ | ✅ IELTS-style |
| Production (Speaking) | ⚡ Repeat | ✅ Guided | ✅ | ✅ Timed |
| Production (Writing) | ❌ | ⚡ Simple | ✅ | ✅ Essays |
| Exit Ticket | ✅ | ✅ | ✅ | ✅ |
| AI Production Mode | ❌ | ❌ | ⚡ | ✅ |

Legend: ✅ = Full | ⚡ = Adapted | ❌ = Not included
