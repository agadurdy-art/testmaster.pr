        ...
        "listening": {
            ...
            "parts": [
                ...
                },
                {
                    ...
                    "questions": [
                        {"number": "11-12", "type": "multiple_selection", "instruction": "Choose TWO letters, A-E.", "options": ["A all residents, including those in the area near the bypass", "B improved transport options", "C access to the lake", "D parking for residents", "E more open space"], "answer": ["B", "E"], "select_count": 2},
