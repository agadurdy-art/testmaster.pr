        ...
        "listening": {
            ...
            "parts": [
                ...
                },
                {
                    ...
                    "questions": [
                        {"number": "11-12", "type": "multiple_selection", "instruction": "Choose TWO letters, A-E.", "question_text": "Which TWO facilities which are planned for


 Lilford will benefit all the__(residents)__?", "options": ["A all residents, including those in the area near the bypass", "B improved transport options", "C access to the lake", "D parking for residents", "E more open space"], "answer": ["B", "E"], "select_count": 2},
                        {"number": "13-14", "type": "multiple_selection", "instruction": "Choose TWO letters, A-E.", "question_text": "Which TWO facilities in


 the__(__(__(__(__(development)__)__)__)__)__ that__(__(__(__(are)__)__)__)__
...
lake?", "options": ["A a shopping centre", "B a sports centre", "C a school", "D a cinema", "E a library"], "answer": ["B", "C"], "select_count": 2},
                        {"number": 15, "type": "map_labelling", "question_text": "playground", "answer": "G"},
                        {"number": 16, "type": "map_labelling", "question_text": "sports centre", "answer": "C"},
                        {"number": 17, "type": "map_labelling", "question_text": "supermarket", "answer": "D"},
                        {"number": 18, "type": "map_labelling", "question_text": "children's clinic", "answer": "B"},
                ...
                },
                {
                    ...
                    "questions": [
                        ...
                        {"number": 33, "type": "note_completion", "answer": "tailor"},
                        {"number": 34, "type": "note_completion", "answer": "profession"},
                        {"number": 35, "type": "note_completion", "answer": "visible"},
                        {"number": 36, "type": "note_completion", "answer": "string"},
                        {"number": 37, "type": "note_completion", "answer": "waist"},
                        {"number": 38, "type": "note_completion", "answer": "perfume"},
                        {"number": 39, "type": "note_completion", "answer": "image"},
                        {"number": 40, "type": "note_completion", "answer": "handbag"}
                    ]
                }
            ]
        },
        "reading": {
            ...
            "passages": [
                ...
                },
                {
                    ...
                    "question_count": 13,
                    "text": "This has been the decade of AI, with one astonishing feat after another. A chess-playing AI that can defeat not only all human chess players, but also all previous human-programmed chess machines, after learning the game in just four hours? That is yesterday's news, what is next? True, these prodigious accomplishments are all in so-called narrow AI, where machines perform highly specialised tasks. But many experts believe this restriction is very temporary. By mid-century, we may have artificial general intelligence (AGI) - machines that can achieve human-level performance on the full range of tasks that we ourselves can tackle.\n\nIf so, there is little reason to think it will stop there. Machines will be free of many of the physical constraints on human intelligence. Our brains run at slow biochemical processing speeds on the power of a light bulb, and their size is restricted by the dimensions of the human birth canal. It is remarkable what they accomplish, given these handicaps. But they may be as far from the physical limits of thought as our eyes are from the incredibly powerful Webb Space Telescope.\n\nOnce machines are better than us at designing even smarter machines, progress towards these limits could accelerate. What would this mean for us? Could we ensure a safe and worthwhile coexistence with such machines? On the plus side, AI is already useful and profitable for many things, and super AI might be expected to be super useful, and super profitable. But the more powerful AI becomes, the more important it will be to specify its goals with great care. Folklore is full of tales of people who ask for the wrong thing, with disastrous consequences - King Midas, for example, might have wished that everything he touched turned to gold, but did not really intend this to apply to his breakfast.\n\nSo we need to create powerful AI machines that are human-friendly - that have goals reliably aligned with our own values. One thing that makes this task difficult is that we are far from reliably human-friendly ourselves. We do many terrible things to each other and to many other creatures with whom we share the planet. If superintelligent machines do not do a lot better than us, we will be in deep trouble. We will have powerful new intelligence amplifying the dark sides of our own fallible natures.\n\nFor safety's sake, then, we want the machines to be ethically as well as cognitively superhuman. We want them to aim for the moral high ground, not for the troughs in which many of us spend some of our time. Luckily they will be smart enough for the job. If there are routes to the moral high ground, they will be better than us at finding them, and steering us in the right direction.\n\nHowever, there are two big problems with this utopian vision. One is how we get the machines started on the journey, the other is what it would mean to reach this destination. The getting started problem is that we need to tell the machines what they are looking for with sufficient clarity that we can be confident they will find it - whatever it actually turns out to be. This will not be easy, given that we are tribal creatures and conflicted about the ideals ourselves.\n\nAs for the destination problem, we might, by putting ourselves in the hands of these moral guides and gatekeepers, be sacrificing our own autonomy - an important part of what makes us human. Machines who are better than us at sticking to the moral high ground may be expected to discourage some of the lapses we presently take for granted. We might lose our freedom to discriminate in favour of our own communities, for example.\n\nLoss of freedom to behave badly is not always a bad thing, of course: denying ourselves the freedom to put children to work in factories, or to smoke in restaurants are signs of progress. But are we ready for ethical silicon police limiting our options?\n\nThese issues might seem far-fetched, but they are to some extent already here. AI already has some input into how resources are used in our National Health Service (NHS) here in the UK, for example. If it was given a greater role, it might do so much more efficiently than humans can manage, and act in the interests of taxpayers and those who use the health system. However, we would be depriving some humans (e.g. senior doctors) of the control they presently enjoy. Since we would want to ensure that people are treated equally and that policies are fair, the goals of AI would need to be specified correctly.\n\nWe have a new powerful technology to deal with - itself, literally, a new way of thinking. For our own safety, we need to point these new thinkers in the right direction, and get them to act well for us. It is not yet clear whether this is possible, but if it is, it will require a cooperative spirit, and a willingness to set aside self-interest.",
                    "questions": [
                        {"number": 14, "type": "multiple_choice", "question_text": "What point does the writer make about AI in the first paragraph?", "options": ["A It is difficult to predict how quickly AI will progress.", "B Much can be learned about the use of AI in chess machines.", "C The future is unlikely to see limitations on the capabilities of AI.", "D Experts disagree on which specialised tasks AI will be able to perform."], "answer": "C"},
                        {"number": 15, "type": "multiple_choice", "question_text": "What is the writer doing in the second paragraph?", "options": ["A explaining why machines will be able to outperform humans", "B describing the characteristics that humans and machines share", "C giving information about the development of machine intelligence", "D indicating which aspects of humans are the most advanced"], "answer": "A"},
                        {"number": 16, "type": "multiple_choice", "question_text": "Why does the writer mention the story of King Midas?", "options": ["A to compare different visions of progress", "B to illustrate that poorly defined objectives can go wrong", "C to emphasise the need for cooperation", "D to point out the financial advantages of a course of action"], "answer": "B"},
                        {"number": 17, "type": "multiple_choice", "question_text": "What challenge does the writer refer to in the fourth paragraph?", "options": ["A encouraging humans to behave in a more principled way", "B deciding which values we want AI to share with us", "C creating a better world for all creatures on the planet", "D ensuring AI is more human-friendly than we are ourselves"], "answer": "D"},
                        {"number": 18, "type": "multiple_choice", "question_text": "What does the writer suggest about the future of AI in the fifth paragraph?", "options": ["A The safety of machines will become a key issue.", "B It is hard to know what impact machines will have on the world.", "C Machines will be superior to humans in certain respects.", "D Many humans will oppose machines having a wider role."], "answer": "C"},
                        {"number": 19, "type": "multiple_choice", "question_text": "Which of the following best summarises the writer's argument in the sixth paragraph?", "options": ["A More intelligent machines will result in greater abuses of power.", "B Machine learning will share very few features with human learning.", "C There are a limited number of people with the knowledge to program machines.", "D Human shortcomings will make creating the machines we need more difficult."], "answer": "D"},
                        {"number": 20, "type": "yes_no_not_given", "statement": "Machines with the ability to make moral decisions may prevent us from promoting the interests of our communities.", "answer": "YES"},
                ...
                },
                {
                    ...
                    "question_count": 14,
                    "text": "The word genius is universally associated with the name of Leonardo da Vinci. A true Renaissance man, he embodied scientific spirit, artistic talent and humanist sensibilities. Five hundred years have passed since Leonardo died in his home at Chateau du Clos Luce, outside Tours, France. Yet far from fading into insignificance, his thinking has carried down the centuries and still surprises today.\n\nThe Renaissance marked the transition from the 15th century to modernity and took place after the spread of the plague in the 14th century, which caused a global crisis resulting in some 200 million deaths across Europe and Asia. Today, the world is on the cusp of a climate crisis, which is predicted to cause widespread displacement, extinctions and death, if left unaddressed. Then, as now, radical solutions were called for to revolutionise the way people lived and safeguard humanity against catastrophe.\n\nAround 1486, after a pestilence that killed half the population in Milan, Italy, Leonardo turned his thoughts to urban planning problems. Following a typical Renaissance trend, he began to work on an ideal city project, which, due to its excessive costs, would remain unfulfilled. Yet given that unsustainable urban models are a key cause of global climate change today, it is only natural to wonder how Leonardo might have changed the shape of modern cities.\n\nAlthough the Renaissance is renowned as an era of incredible progress in art and architecture, it is rarely noted that the 15th century also marked the birth of urbanism as a true academic discipline. The rigour and method behind the conscious conception of a city had been largely missing in Western thought until the moment when prominent Renaissance men pushed forward large-scale urban projects in Italy, such as the reconfiguration of the town of Pienza and the expansion of the city of Ferrara. These works surely inspired Leonardo's decision to rethink the design of medieval cities, with their winding and overcrowded streets and with houses piled against one another.\n\nIt is not easy to identify a coordinated vision of Leonardo's ideal city because of his disordered way of working with notes and sketches. But from the largest collection of Leonardo's papers ever assembled, a series of innovative thoughts can be reconstructed regarding the foundation of a new city along the Ticino River, which runs from Switzerland into Italy and is 248 kilometres long. He designed the city for the easy transport of goods and clean urban spaces, and he wanted a comfortable and spacious city, with well-ordered streets and architecture.\n\nHis plans for a modern and rational city were consistent with Renaissance ideals. But, in keeping with his personality, Leonardo included several innovations in his urban design. Leonardo wanted the city to be built on several levels, linked with vertical outdoor staircases. This design can be seen in some of today's high-rise buildings but was unconventional at the time.\n\nWhile in the upper layers of the city, people could walk undisturbed between elegant palaces and streets, the lower layer was the place for services, trade, transport and industry. But the true originality of Leonardo's vision was its fusion of architecture and engineering. Leonardo designed extensive hydraulic plants to create artificial canals throughout the city.\n\nAlthough some of these features existed in Roman cities, before Leonardo's drawings there had never been a multi-level, compact modern city which was thoroughly technically conceived. Indeed, it was not until the 19th century that some of his ideas were applied. Paris is one example of a city that was redesigned in the 19th century in the way that Leonardo had envisaged.\n\nToday, Leonardo's ideas are not simply valid, they actually suggest a way forward for urban planning. Many scholars think that the compact city, built upwards instead of outwards, integrated with nature, with efficient transport infrastructure, could help modern cities become more efficient and sustainable.",
                    "questions": [
                        {"number": 27, "type": "true_false_not_given", "statement": "People first referred to Leonardo da Vinci as a genius 500 years ago.", "answer": "NOT GIVEN"},
                        {"number": 28, "type": "true_false_not_given", "statement": "The current climate crisis is predicted to cause more deaths than the plague.", "answer": "NOT GIVEN"},
                        {"number": 29, "type": "true_false_not_given", "statement": "Some of the challenges we face today can be compared to those of earlier times.", "answer": "TRUE"},
                        {"number": 30, "type": "true_false_not_given", "statement": "Leonardo da Vinci's ideal city was constructed in the 15th century.", "answer": "FALSE"},
                        {"number": 31, "type": "true_false_not_given", "statement": "Poor town planning is a major contributor to climate change.", "answer": "TRUE"},
                        {"number": 32, "type": "true_false_not_given", "statement": "In Renaissance times, local people fought against the changes to Pienza and Ferrara.", "answer": "NOT GIVEN"},
                        {"number": 33, "type": "true_false_not_given", "statement": "Leonardo da Vinci kept a neat, organised record of his designs.", "answer": "FALSE"},
                        {"number": 34, "type": "summary_completion", "question_text": "A collection of Leonardo da Vinci's paperwork reveals his design of a new city beside the Ticino River. This was to provide better _____ for trade", "answer": "transport"},
                        {"number": 35, "type": "summary_completion", "question_text": "They included features that can be seen in some tower blocks today, such as _____ on the exterior of a building.", "answer": "staircases"},
                        {"number": 36, "type": "summary_completion", "question_text": "His expertise in _____ was evident in his plans for artificial canals.", "answer": "engineering"},
                        {"number": 37, "type": "summary_completion", "question_text": "The design of many cities in Italy today follows this _____.", "answer": "rule"},
                        {"number": 38, "type": "summary_completion", "question_text": "While some cities from _____ times have aspects that can also be found in Leonardo's designs", "answer": "Roman"},
                        {"number": 39, "type": "summary_completion", "question_text": "_____ is one example of a city that was redesigned in the 19th century in the way that Leonardo had envisaged.", "answer": "Paris"},
                        {"number": 40, "type": "summary_completion", "question_text": "His ideas are also relevant to today's world, where building _____ no longer seems to be the best approach.", "answer": "outwards"}
                    ]
                }
            ]
        },
