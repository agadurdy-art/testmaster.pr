"""
GE game-bank trilingual vocabulary data. Extracted from routes/game_bank.py (Faz 1 refactor, 2026-07-02). DATA ONLY — no logic.

This is GENERAL ENGLISH product data (EN/VI/TR mini-game vocabulary, game UI strings,
true/false question bank) — not IELTS content.
"""
