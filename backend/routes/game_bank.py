...
VOCABULARY_DATA = {
    ...
    "weather": [
        {"word": "sunny", "meaning": "güneşli", "image": "☀️", "example": "It's sunny today."},
        {"word": "rainy", "meaning": "yağmurlu", "image": "🌧️", "example": "Bring an umbrella, it's rainy."},
        {"word": "cloudy", "meaning": "bulutlu", "image": "☁️", "example": "The sky is cloudy."},
        {"word": "windy", "meaning": "rüzgarlı", "image": "💨", "example": "It's too windy outside."},
        {"word": "snowy", "meaning": "karlı", "image": "❄️", "example": "Winters are snowy here."},
        {"word": "hot", "meaning": "sıcak", "image": "🔥", "example": "Summer is very hot."},
        {"word": "cold", "meaning": "soğuk", "image": "🥶", "example": "Winter is cold."},
        {"word": "storm", "meaning": "fırtına", "image": "⛈️", "example": "A storm is coming."},
    ],
    "travel": [
        {"word": "airport", "meaning": "havalimanı", "image": "✈️", "example": "We arrived at the airport."},
        {"word": "hotel", "meaning": "otel", "image": "🏨", "example": "The hotel was comfortable."},
        {"word": "passport", "meaning": "pasaport", "image": "🛂", "example": "Don't forget your passport."},
        {"word": "ticket", "meaning": "bilet", "image": "🎫", "example": "I booked a ticket online."},
        {"word": "luggage", "meaning": "bagaj", "image": "🧳", "example": "My luggage is heavy."},
        {"word": "tourist", "meaning": "turist", "image": "🧑‍🦱", "example": "Many tourists visit this city."},
        {"word": "vacation", "meaning": "tatil", "image": "🏖️", "example": "I need a vacation."},
        {"word": "journey", "meaning": "yolculuk", "image": "🚀", "example": "Enjoy your journey!"},
    ],
    "health": [
        {"word": "doctor", "meaning": "doktor", "image": "👨‍⚕️", "example": "The doctor helped me."},
        {"word": "medicine", "meaning": "ilaç", "image": "💊", "example": "Take your medicine."},
        {"word": "hospital", "meaning": "hastane", "image": "🏥", "example": "He went to the hospital."},
        {"word": "healthy", "meaning": "sağlıklı", "image": "💪", "example": "Eat healthy food."},
        {"word": "exercise", "meaning": "egzersiz", "image": "🏃", "example": "Exercise every day."},
        {"word": "fever", "meaning": "ateş", "image": "🤒", "example": "I have a fever."},
        {"word": "headache", "meaning": "baş ağrısı", "image": "🤕", "example": "I have a headache."},
        {"word": "rest", "meaning": "dinlenme", "image": "😴", "example": "You need to rest."},
    ],
    "jobs": [
        {"word": "teacher", "meaning": "öğretmen", "image": "👩‍🏫", "example": "My teacher is helpful."},
        {"word": "doctor", "meaning": "doktor", "image": "👨‍⚕️", "example": "I want to be a doctor."},
        {"word": "engineer", "meaning": "mühendis", "image": "👷", "example": "Engineers build bridges."},
        {"word": "nurse", "meaning": "hemşire", "image": "👩‍⚕️", "example": "The nurse is caring."},
        {"word": "police", "meaning": "polis", "image": "👮", "example": "Police keep us safe."},
        {"word": "chef", "meaning": "aşçı", "image": "👨‍🍳", "example": "The chef cooks well."},
        {"word": "pilot", "meaning": "pilot", "image": "👨‍✈️", "example": "Pilots fly planes."},
        {"word": "artist", "meaning": "sanatçı", "image": "👨‍🎨", "example": "Artists are creative."},
    ],
    "home": [
        {"word": "bedroom", "meaning": "yatak odası", "image": "🛏️", "example": "I sleep in my bedroom."},
        {"word": "kitchen", "meaning": "mutfak", "image": "🍳", "example": "We cook in the kitchen."},
        {"word": "bathroom", "meaning": "banyo", "image": "🛁", "example": "The bathroom is clean."},
        {"word": "garden", "meaning": "bahçe", "image": "🌷", "example": "Our garden has flowers."},
        {"word": "living room", "meaning": "oturma odası", "image": "🛋️", "example": "We watch TV in the living room."},
        {"word": "window", "meaning": "pencere", "image": "🪟", "example": "Open the window please."},
        {"word": "door", "meaning": "kapı", "image": "🚪", "example": "Close the door."},
        {"word": "furniture", "meaning": "mobilya", "image": "🪑", "example": "We bought new furniture."},
    ],
    "ielts_academic": [
        {"word": "research", "meaning": "araştırma", "image": "🔬", "example": "The research was published."},
        {"word": "analysis", "meaning": "analiz", "image": "📊", "example": "Data analysis is important."},
        {"word": "evidence", "meaning": "kanıt", "image": "📋", "example": "There is strong evidence."},
        {"word": "conclusion", "meaning": "sonuç", "image": "✅", "example": "In conclusion, I agree."},
        {"word": "significant", "meaning": "önemli", "image": "⭐", "example": "This is significant progress."},
        {"word": "hypothesis", "meaning": "hipotez", "image": "💡", "example": "Test your hypothesis."},
        {"word": "methodology", "meaning": "metodoloji", "image": "📐", "example": "Explain your methodology."},
        {"word": "evaluation", "meaning": "değerlendirme", "image": "📝", "example": "The evaluation was positive."},
    ],
}
