...
Let us end with Einstein, the epitome of a genius. He clearly had curiosity, character and determination. He struggled against rejection early in life but was undeterred. Did he think he was a genius or even gifted? He once wrote: 'It's not that I'm so smart, it's just that I stay with problems longer.' Most people say it is the intellect which makes a great scientist. They are wrong: it is character.'"""
        ...
        "answer_key": [
            ...
            {"question_id": 23, "answer": "B", "explanation": "Paragraph A describes the symptoms Raducanu experienced during the tournament - 'she began having difficulty regulating her breathing and heart rate'."},
            {"question_id": 24, "answer": "D", "explanation": "When writing about her withdrawal from the Wimbledon Tournament on social media, Raducanu referred to 'the physical demands of the tournament' and 'the intense psychological pressure'."},
            {"question_id": 25, "answer": "A", "explanation": "According to Paragraph E, 'The intensity with which a person experiences anxiety (how severe the anxiety is) depends on the demands and resources they have.'"},
            {"question_id": 26, "answer": "E", "explanation": "The final sentence in Paragraph E describes how 'repeated episodes of anxiety can increase risk of heart disease and depression'."},
