...
Recognizing these biases doesn't eliminate them, but awareness can help individuals develop strategies to counteract their effects. These include seeking diverse perspectives, using decision-making frameworks, and slowing down to engage analytical rather than intuitive thinking processes."""
        ...
        "questions": [
            ...
            {"id": 6, "passage": 1, "type": "matching_information", "question": "Which paragraph discusses modern bicycle innovations?", "options": ["A) Paragraph 1", "B) Paragraph 2", "C) Paragraph 3", "D) Paragraph 4"]},
            
            # Passage 2 Questions (14-26)
            {"id": 7, "passage": 2, "type": "true_false_notgiven", "question": "Coral reefs cover more than 1% of the ocean floor."},
            {"id": 8, "passage": 2, "type": "true_false_notgiven", "question": "Zooxanthellae provide most of the coral's energy."},
            {"id": 9, "passage": 2, "type": "multiple_choice", "question": "What percentage of coral reefs will be lost if global warming reaches 1.5°C?", "options": ["A) 25%", "B) 50%", "C) 70-90%", "D) 100%"]},
            {"id": 10, "passage": 2, "type": "sentence_completion", "question": "Coral bleaching occurs when corals expel _______ from their tissues."},
            {"id": 11, "passage": 2, "type": "yes_no_notgiven", "question": "Scientists believe coral reefs can be saved without reducing greenhouse gas emissions."},
            
            # Passage 3 Questions (27-40)
            {"id": 12, "passage": 3, "type": "multiple_choice", "question": "The availability heuristic causes people to:", "options": ["A) Make rational decisions", "B) Judge probability based on how easily examples come to mind", "C) Ignore all statistics", "D) Only trust recent information"]},
            {"id": 13, "passage": 3, "type": "true_false_notgiven", "question": "Confirmation bias only affects scientific research."},
            {"id": 14, "passage": 3, "type": "sentence_completion", "question": "Prospect theory was developed by Daniel Kahneman and _______."},
            {"id": 15, "passage": 3, "type": "matching_headings", "question": "Which paragraph discusses loss aversion?", "options": ["A) Paragraph 2", "B) Paragraph 3", "C) Paragraph 4", "D) Paragraph 5"]},
        ],
        "answer_key": [
