"""Seed script for IELTS Beginner Course (Band 4.5 and below)"""
import asyncio
import os
...
BEGINNER_LESSONS = [
    {
        ...
        "reading": {
            ...
            "questions": [
                {"id": "r1_1", "question": "Is Anna's family big?", "answer": "No, Anna has a small family."},
                {"id": "r1_2", "question": "What does her father do?", "answer": "Her father is a doctor."}
            ]
        },
        "speaking": {
    ...
    },
    {
        ...
        "reading": {
            ...
            "questions": [
                {"id": "r2_1", "question": "What time does the person wake up?", "answer": "The person wakes up at seven o'clock."},
                {"id": "r2_2", "question": "What does the person do after dinner?", "answer": "The person watches TV or reads a book."}
            ]
        },
        "speaking": {
    ...
    },
    {
        ...
        "reading": {
            ...
            "questions": [
                {"id": "r3_1", "question": "Why is healthy food good?", "answer": "Healthy food gives us energy."},
                {"id": "r3_2", "question": "Is fast food healthy?", "answer": "No, fast food is not very healthy."}
            ]
        },
        "speaking": {
        ...
        "common_mistake": {
            "incorrect": "I like very much pizza.",
    ...
    },
    {
        ...
        "reading": {
            ...
            "questions": [
                {"id": "r4_1", "question": "Where do doctors work?", "answer": "Doctors work in a hospital."},
                {"id": "r4_2", "question": "Why is work important?", "answer": "We need work to earn money."}
            ]
        },
        "speaking": {
    ...
    },
    {
        ...
        "reading": {
            ...
            "questions": [
                {"id": "r5_1", "question": "What subjects do children study?", "answer": "Children study subjects like English and math."},
                {"id": "r5_2", "question": "Where can adults learn new skills?", "answer": "Adults can learn online or at a college."}
            ]
        },
        "speaking": {
        ...
        "common_mistake": {
            "incorrect": "I study in the school.",
    ...
    },
    {
        ...
        "reading": {
            ...
            "questions": [
                {"id": "r6_1", "question": "How did they travel to the mountains?", "answer": "They traveled by train."},
                {"id": "r6_2", "question": "Where did they stay?", "answer": "They stayed in a small hotel."}
            ]
        },
        "speaking": {
    ...
    },
    {
        ...
        "reading": {
            ...
            "questions": [
                {"id": "r7_1", "question": "What should you do if you feel sick?", "answer": "You should see a doctor."},
                {"id": "r7_2", "question": "How many hours should you sleep?", "answer": "You should sleep for eight hours."}
            ]
        },
        "speaking": {
    ...
    },
    {
        ...
        "reading": {
            ...
            "questions": [
                {"id": "r8_1", "question": "What is a quiet hobby?", "answer": "Reading books or painting is a quiet hobby."},
                {"id": "r8_2", "question": "Why are hobbies good?", "answer": "Hobbies help us relax and meet new friends."}
            ]
        },
        "speaking": {
    ...
    },
    {
        ...
        "reading": {
            ...
            "questions": [
                {"id": "r9_1", "question": "Why are laptops popular?", "answer": "Laptops are popular because you can carry them easily."},
                {"id": "r9_2", "question": "What can you find on the internet?", "answer": "You can find answers to almost any question."}
            ]
        },
        "speaking": {
    ...
    },
    {
        ...
        "reading": {
            ...
            "questions": [
                {"id": "r10_1", "question": "Why is pollution bad?", "answer": "Pollution makes the air dirty and is bad for our lungs."},
                {"id": "r10_2", "question": "How can we save water?", "answer": "Do not leave the water running when you brush your teeth."}
            ]
        },
        "speaking": {
        ...
        "common_mistake": {
            "incorrect": "The nature is beautiful.",
    ...
    },
    {
        ...
        "reading": {
            ...
            "questions": [
                {"id": "r11_1", "question": "Where do people put their money?", "answer": "People put their money in a bank."},
                {"id": "r11_2", "question": "How can you buy things at a lower price?", "answer": "You can look for sales."}
            ]
        },
        "speaking": {
    ...
    },
    {
        ...
        "reading": {
            ...
            "questions": [
                {"id": "r12_1", "question": "What floor is the apartment on?", "answer": "The apartment is on the third floor."},
                {"id": "r12_2", "question": "What is in the living room?", "answer": "There is a big sofa and a TV."}
            ]
        },
        "speaking": {
        ...
        "common_mistake": {
            "incorrect": "There is many people.",
    ...
    },
    {
        ...
        "reading": {
            ...
            "questions": [
                {"id": "r13_1", "question": "Why are bicycles good for the environment?", "answer": "Bicycles do not make pollution."},
                {"id": "r13_2", "question": "What is a subway?", "answer": "A subway is a train that goes under the ground."}
            ]
        },
        "speaking": {
    ...
    },
    {
        ...
        "reading": {
            ...
            "questions": [
                {"id": "r14_1", "question": "What do people use when it rains?", "answer": "People use an umbrella."},
                {"id": "r14_2", "question": "What are the four seasons?", "answer": "Spring, summer, autumn, and winter."}
            ]
        },
        "speaking": {
        ...
        "common_mistake": {
            "incorrect": "It is very sun.",
            "correct": "It is very sunny."
        }
    }
]

async def seed_beginner_course():
    """Seed the beginner course lessons"""
    client = AsyncIOMotorClient(os.environ.get('MONGO_URL'))
    db = client['ielts_ace']
    
    # Clear existing beginner lessons
    await db.beginner_lessons.delete_many({})
    
    # Insert all lessons
    if BEGINNER_LESSONS:
        await db.beginner_lessons.insert_many(BEGINNER_LESSONS)
        print(f"✅ Seeded {len(BEGINNER_LESSONS)} beginner course lessons")
    
    return True

if __name__ == "__main__":
    asyncio.run(seed_beginner_course())
