...
Source folder: ~/Desktop/Stage3_Unit3_Final/
...
SRC = Path.home() / "Desktop" / "Stage3_Unit3_Final"
ENRICHED = REPO_ROOT / "backend" / "content" / "enriched"
R2_PUBLIC_BASE = "https://pub-fcd31e7869f94c4896d039253b8f1646.r2.dev"
R2_PREFIX = "vocab"

# Filename stems use underscores + lowercase; some Unit 3 vocab words
# have spaces ("dining room", "living room", "next to") or unusual case
# ("TV") — map them back so the JSON walker finds the items.
...
def main():
    ...
    total_refs = 0
    for json_path in sorted(ENRICHED.glob("stage3_unit03_enriched.json")):
