...
WORD_PROMPTS = {
    ...
    # Unit 02 — Families + feelings (gender markers explicit so Flux
    # produces the right person consistently — earlier "a kind mother"
    # sometimes rendered a man).
    "mum":      "a happy WOMAN, female, mother in her 30s with long hair, smiling, head-and-shoulders portrait, holding a coffee cup, plain background",
    ...
    "son":      "a smiling BOY aged 10, male child, hugging his parents, only the boy's face is the focus, plain background",
    "daughter": "a smiling GIRL aged 10, female child, standing with her parents, only the girl's face is the focus, plain background",
    "baby":     "a happy human BABY smiling, baby clothes, plain background",
    "parents":  "a MOTHER and FATHER standing together — one woman with long hair on the LEFT and one man with short hair on the RIGHT, both smiling, head-and-shoulders portrait",
