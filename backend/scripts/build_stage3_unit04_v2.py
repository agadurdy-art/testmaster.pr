...
DEFS = {
    ...
    "rubber":      ("🧽", "A small thing that removes pencil marks.",            "Where is my rubber? I made a mistake."),
    "ruler":       ("📏", "A flat thing for measuring or drawing straight lines.","Use a ruler to draw a line."),
    "pencil case": ("🖍️", "A small bag for your pens and pencils.",             "My pencil case is full."),
