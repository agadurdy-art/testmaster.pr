// LegacyDashboardPage — the mode-branched legacy dashboard (route /dashboard/legacy).
// Orchestrator extracted from pages/Dashboard.js (Faz1 refactor); body verbatim.
// The header and the Play & Fun / Your Progress sections moved to ./components/
// with closed-over values passed as same-named props. Every learning_mode branch
// is preserved VERBATIM: GE users get filtered learningTools, no Practice & Test
// section, the GE ladder copy in the Learning Path CTA, and no Tests block in the
// mobile menu (inside LegacyHeader).
import React, { useState, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import { Button } from '../../../../components/ui/button';
import { Card } from '../../../../components/ui/card';
import {
  BookOpen, Headphones, Mic, PenTool, Target, BookMarked,
  MessageSquare, ChevronRight, Clock, Award, Sparkles,
  GraduationCap, BarChart3, Flame, Star, Zap, LayoutDashboard, FileText,
  Play, ArrowRight, Lightbulb, CheckCircle, HelpCircle, Lock, AlertTriangle,
} from 'lucide-react';
...
import { buildWelcomeSubtitle } from './lib';
import LegacyHeader from './components/LegacyHeader';
import PlayFunSection from './components/PlayFunSection';
