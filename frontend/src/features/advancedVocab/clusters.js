...
export const ACCENT_STYLES = {
  amber: {
    ...
    chipSoft: 'bg-amber-50 text-amber-700',
    text: 'text-amber-700',
    pill: 'bg-amber-500 text-white',
    ring: 'ring-amber-300',
    headerTint: 'from-amber-50 to-white',
  },
  indigo: {
    ...
    headerTint: 'from-indigo-50 to-white',
  },
  emerald: {
    border: 'border-l-emerald-500',
    chip: 'bg-emerald-100 text-emerald-800',
    chipSoft: 'bg-emerald-50 text-emerald-700',
    text: 'text-emerald-700',
    pill: 'bg-emerald-500 text-white',
    ring: 'ring-emerald-300',
    headerTint: 'from-emerald-50 to-white',
  },
  rose: {
    ...
    ring: 'ring-rose-300',
    headerTint: 'from-rose-50 to-white',
  },
};
