...
const PLANS = [
  ...
  },
  {
    ...
    unit: '/ week',
    tag: 'Short sprint',
    feats: ['Unlimited writing + speaking', 'Courses + progress'],
  ...
  },
  {
    ...
    unit: '/ month',
    tag: 'Most popular',
    feats: ['Everything in Weekly', 'Full Liz access', 'Priority AI queue'],
  ...
  },
  {
    ...
    unit: 'once',
    tag: '30 days',
    feats: ['One-time payment', '30-day full access', 'No renewal'],
