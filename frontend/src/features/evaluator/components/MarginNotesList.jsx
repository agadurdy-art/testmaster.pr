...
export default function MarginNotesList({ annotations, className }) {
  ...
  return (
    <aside
      className={cn(
        "flex flex-col gap-3",
        // Desktop gets an independent scroll column beside the essay; on
        // mobile the grid stacks vertically, so we let the page scroll
        // naturally instead of trapping the list in its own overflow box.
