          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-100 text-amber-700 text-sm font-medium mb-4">
                ...
                {t('landingTryLessonsBadge')}
              </div>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
                {t('landingTryLessonsTitle')}
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                {t('landingTryLessonsDesc')}
              </p>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* First 3 modules - FREE PREVIEW */}
              {previewModules.slice(0, 3).map((module, idx) => (
                <Card 
                  key={module.id}
                  onClick={() => navigate(`/lesson-preview/${module.id}`)}
                  className="p-6 bg-white border-0 shadow-lg hover:shadow-xl cursor-pointer group transition-all duration-300 hover:-translate-y-2 rounded-2xl relative overflow-hidden"
                >
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-white font-bold text-lg shadow-lg group-hover:scale-110 transition-transform">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                      ...
                      <span>{t('landingLessonVocab')}</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                      <Brain className="w-4 h-4 text-purple-500" />
                      <span>{t('landingLessonGrammar')}</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                      <PenTool className="w-4 h-4 text-orange-500" />
                      <span>{t('landingLessonWriting')}</span>
                    </div>
                  </div>
                  <Button className="w-full bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white border-0">
                    {t('landingStartLesson')} <ArrowRight className="w-4 h-4 ml-2" />
                  </Button>
                </Card>
              ))}

              {/* Locked modules placeholder - showing what's available after sign up */}
              {[4, 5, 6].map((num) => (
                <Card 
                  key={num}
                  onClick={() => setShowAuth(true)}
                  className="p-6 bg-gray-100 border-0 shadow-lg cursor-pointer group transition-all duration-300 hover:shadow-xl rounded-2xl relative overflow-hidden"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-gray-200/50 to-gray-300/50 backdrop-blur-[2px] flex flex-col items-center justify-center z-10">
                    <div className="w-14 h-14 rounded-full bg-gray-300 flex items-center justify-center mb-3">
                      <Lock className="w-7 h-7 text-gray-500" />
                    </div>
                    <p className="text-gray-600 font-medium text-center px-4">{t('landingSignUpToUnlock')}</p>
                    <Button 
                      size="sm" 
                  ...
                  <div className="opacity-30">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-12 h-12 rounded-xl bg-gray-300 flex items-center justify-center text-gray-500 font-bold text-lg">
                        {num}
                      </div>
            ...
            <div className="mt-10 text-center">
              <p className="text-gray-600 mb-4">{t('landingMoreLessons')}</p>
              <Button 
                onClick={() => setShowAuth(true)} 
                size="lg"
                className="bg-gradient-to-r from-violet-600 to-purple-700 hover:from-violet-700 hover:to-purple-800 text-white px-8"
              >
                {t('landingUnlockAll')} <ChevronRight className="w-5 h-5 ml-2" />
              </Button>
            </div>
          </div>
        </section>
