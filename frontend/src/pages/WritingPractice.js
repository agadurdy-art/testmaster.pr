...
const WRITING_PROMPTS = {
  task1_academic: [
    { id: 'ac1', title: 'Line Graph - Internet Usage', prompt: 'The graph below shows the percentage of households with access to the internet in three different countries between 2000 and 2020.\n\nSummarize the information by selecting and reporting the main features, and make comparisons where relevant.\n\n[DATA REFERENCE]\n• Country A: 2000 (25%) → 2010 (60%) → 2020 (92%)\n• Country B: 2000 (15%) → 2010 (45%) → 2020 (85%)\n• Country C: 2000 (5%) → 2010 (20%) → 2020 (55%)', type: 'line_graph' },
    { id: 'ac2', title: 'Bar Chart - Energy Sources', prompt: 'The bar chart below shows the percentage of electricity generated from different sources in four countries.\n\nSummarize the information by selecting and reporting the main features, and make comparisons where relevant.\n\n[DATA REFERENCE]\n• Australia: Coal (65%), Gas (20%), Renewables (10%), Nuclear (5%)\n• France: Nuclear (70%), Renewables (15%), Gas (10%), Coal (5%)\n• Brazil: Renewables (75%), Gas (15%), Coal (5%), Nuclear (5%)\n• China: Coal (55%), Renewables (25%), Gas (10%), Nuclear (10%)', type: 'bar_chart' },
    { id: 'ac3', title: 'Process Diagram - Water Treatment', prompt: 'The diagram below shows the process of treating water to make it drinkable.\n\nSummarize the information by selecting and reporting the main features.\n\n[PROCESS STEPS]\n1. Raw water intake from river/reservoir\n2. Screening to remove large debris\n3. Coagulation: chemicals added to bind particles\n4. Sedimentation: particles settle at bottom\n5. Filtration: water passes through sand/charcoal filters\n6. Disinfection: chlorine/UV treatment kills bacteria\n7. Storage in clean water tanks\n8. Distribution to households via pipes', type: 'process' }
  ],
  task1_general: [
