...
const WRITING_PROMPTS = {
  task1_academic: [
    { id: 'ac1', title: 'Line Graph - Internet Usage', prompt: 'The graph below shows the percentage of households with access to the internet in three different countries between 2000 and 2020.\n\nSummarize the information by selecting and reporting the main features, and make comparisons where relevant.', imageUrl: '/static/images/migrated/zkfesaxt_Screenshot_2025-12-18_at_11_06_08_fb562563.png', type: 'line_graph' },
    { id: 'ac2', title: 'Bar Chart - Energy Sources', prompt: 'The bar chart below shows the percentage of electricity generated from different sources in four countries.\n\nSummarize the information by selecting and reporting the main features, and make comparisons where relevant.', imageUrl: '/static/images/migrated/t9vh6l2n_Code_Generated_Image_94003211.png', type: 'bar_chart' },
    { id: 'ac3', title: 'Process Diagram - Water Treatment', prompt: 'The diagram below shows the process of treating water to make it drinkable.\n\nSummarize the information by selecting and reporting the main features.', imageUrl: '/static/images/migrated/oslspp62_Gemini_Generated_Image_njmstsnjmstsnjms_3a0ea078.png', type: 'process' }
  ],
  task1_general: [
