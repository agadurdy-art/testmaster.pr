      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {testType === 'reading' ? (
          <div className="flex flex-col min-h-[calc(100vh-220px)] mb-20">
            ...
            {/* Question Navigation Bar - Full width, single scrollable row */}
            <div className="mb-2">
              <QuestionNavigation
            ...
            <div className="flex flex-col lg:flex-row gap-4 flex-1 lg:h-[calc(100vh-340px)]">
              {/* Left Column - Passage */}
              <div className="flex flex-col" style={{ flexBasis: typeof window !== 'undefined' && window.innerWidth >= 1024 ? `${passageRatio}%` : '100%', flexShrink: 0 }}>
