      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {testType === 'reading' ? (
          <div className="flex flex-col min-h-[calc(100vh-220px)] mb-20">
            ...
            {/* Question Navigation Bar - Full width, single row, scrollable on mobile */}
            <div className="mb-2">
              <QuestionNavigation
            ...
            {/* Two Column Layout with Dynamic Width */}
            <div className="flex flex-col lg:flex-row gap-4 flex-1 lg:h-[calc(100vh-340px)]">
              {/* Left Column - Passage */}
              <div className="lg:flex-none flex flex-col" style={{ width: typeof window !== 'undefined' && window.innerWidth >= 1024 ? `${passageRatio}%` : '100%' }}>
              ...
              <div className="lg:flex-1 flex flex-col min-w-[280px]">
                <Card className="flex-1 overflow-hidden flex flex-col">
                  {/* Passage Tabs */}
