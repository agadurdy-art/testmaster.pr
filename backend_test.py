...
BACKEND_URL = "https://ielts-master-mode.preview.emergentagent.com/api"
...
if __name__ == "__main__":
    ...
    print(f"   Speaking QB Evaluation Tiers (PRIORITY - CURRENT REVIEW): {'✅ PASSED' if speaking_qb_success else '❌ FAILED'}")
    print(f"   Mastery Reading Question Bank Implementation (CURRENT REVIEW): {'✅ PASSED' if mastery_reading_success else '❌ FAILED'}")
